...
const SecondPage = () => (
  <Layout>
    ...
    <div>
      <h1> Privacy Policy for www.guitarcomposerstoolbox.com </h1>
      <p>
        {" "}
      ...
      <p>
        {" "}
        At www.guitarcomposerstoolbox.com, the privacy of our visitors is of
        ...
        www.guitarcomposerstoolbox.com and how it is used.{" "}
      </p>
      <p>
        {" "}
        <b>Log Files</b>
        <br /> Like many other Web sites, www.guitarcomposerstoolbox.com makes
      ...
      <p>
        ...
        <br /> www.guitarcomposerstoolbox.com does use cookies to store
        information about visitors preferences, record user-specific information
        on which pages the user access or visit, customize Web page content
        based on visitors browser type or other information that the visitor
      ...
      <p>
        ...
        www.guitarcomposerstoolbox.com.
        <br />
        .:: Google's use of the DART cookie enables it to serve ads to your
        users based on their visit to www.guitarcomposerstoolbox.com and other
      ...
      <p>
        ...
        site. Our advertising partners include ....... <br /> Google Adsense
        <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br />{" "}
      </p>
      <p>
        {" "}
        These third-party ad servers or ad networks use technology to the
        advertisements and links that appear on www.guitarcomposerstoolbox.com
      ...
      <p>
        {" "}
        www.guitarcomposerstoolbox.com has no access to or control over these
      ...
      <p>
        ...
        www.guitarcomposerstoolbox.com's privacy policy does not apply to, and
